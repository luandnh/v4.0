...
if ($list_id_ct != NULL) {
	...
	$partner_code 	= $output->data->partner_code;
}
...
$output_script = $ui->getAgentScript($lead_id, $fullname, $first_name, $last_name, $middle_initial, $email, $phone_number, $alt_phone, $address1, $address2, $address3, $city, $province, $partner_code, $postal_code, $country);
$disposition = $api->API_getLeadDispositions($lead_id);
							...
							<div id="activity" role="tabpanel" class="tab-pane">
								<div class="box collapsed-box">
									<div class="box-header with-border btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Show <?php $lh->translateText("lead_calls"); ?>">
										<em class="glyphicon glyphicon-earphone pull-left"></em>
										<h3 class="box-title pull-left"> <?php $lh->translateText("lead_calls"); ?></h3>
									</div>
									<div class="box-body">
								...
								<div class="box collapsed-box">
									<div class="box-header with-border btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Show <?php $lh->translateText("lead_closer_records"); ?>">
										<em class="glyphicon glyphicon-list-alt pull-left"></em>
										<h3 class="box-title pull-left"> <?php $lh->translateText("lead_closer_records"); ?></h3>
									</div>
									<div class="box-body">
								...
								<div class="box collapsed-box">
									<div class="box-header with-border btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Show <?php $lh->translateText("lead_agent_log"); ?>">
										<em class="glyphicon glyphicon-user pull-left"></em>
										<h3 class="box-title pull-left"> <?php $lh->translateText("lead_agent_log"); ?></h3>
									</div>
									<div class="box-body">
								...
								<div class="box collapsed-box">
									<div class="box-header with-border btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Show <?php $lh->translateText("lead_recordings"); ?>">
										<em class="glyphicon glyphicon-play-circle pull-left"></em>
										<h3 class="box-title pull-left"> <?php $lh->translateText("lead_recordings"); ?></h3>
									</div>
									<div class="box-body">
							...
							<div id="profile" role="tabpanel" class="tab-pane active" data-list-id="<?= $list_id_ct ?>">
								<fieldset>
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="first_name" name="first_name" type="text" maxlength="30" value="<?php echo $first_name; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" required>
											...
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="middle_initial" name="middle_initial" type="text" maxlength="2" value="<?php echo $middle_initial; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-touched">
													<label for="middle_initial"><?php $lh->translateText("middle_initial"); ?></label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="last_name" name="last_name" type="text" maxlength="30" value="<?php echo $last_name; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" required>
									...
									<form id="contact_details_form" class="formMain">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													...
													<input id="phone_number" name="phone_number" type="number" min="0" width="auto" value="<?php echo $phone_number; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" required>
											...
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input id="alt_phone" name="alt_phone" type="number" min="0" width="100" value="<?php echo $alt_phone; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
										...
										<div class="mda-form-group label-floating">
											<input id="address1" name="address1" type="text" width="auto" value="<?php echo $address1; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
										...
										<div class="mda-form-group label-floating">
											<input id="address2" name="address2" type="text" value="<?php echo $address2; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
											<label for="address2"><?php $lh->translateText("address2"); ?></label>
										</div>
										<div class="mda-form-group label-floating">
											<input id="address3" name="address3" type="text" value="<?php echo $address3; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
											<label for="address3"><?php $lh->translateText("address3"); ?></label>
										</div>

										<div class="row">
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input id="city" name="city" type="text" value="<?php echo $city; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
													<label for="city"><?php $lh->translateText("city"); ?></label>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input id="postal_code" name="postal_code" type="text" value="<?php echo $postal_code; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
										...
										<div class="mda-form-group label-floating">
											<input id="country" name="country" type="text" value="<?php echo $country; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
											<label for="country"><?php $lh->translateText("country"); ?></label>
										</div>
										<div class="mda-form-group label-floating">
											<!-- add "mda-input-group" if with image -->
											<input id="email" name="email" type="text" width="auto" value="<?php echo $email; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="identity_number" name="identity_number" type="text" value="<?php echo $identity_number; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
													<label for="identity_number"><?php $lh->translateText("identity_number"); ?></label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="identity_issued_on" name="identity_issued_on" type="text" value="<?php echo $identity_issued_on; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
													<label for="identity_issued_on"><?php $lh->translateText("identity_issued_on"); ?></label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="mda-form-group label-floating">
													<input id="identity_issued_by" name="identity_issued_by" type="text" value="<?php echo $identity_issued_by; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input id="vendor_lead_code" name="vendor_lead_code" type="text" value="<?php echo $vendor_lead_code; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
													<label for="vendor_lead_code"><?php $lh->translateText("vendor_lead_code"); ?></label>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input id="partner_code" name="partner_code" type="text" value="<?php echo $partner_code; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
													<label for="vendor_lead_code">Partner Code</label>
												</div>
											</div>
										</div>
									</form>
									<form role="form" id="gender_form" class="formMain form-inline">
										<div class="row">
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<select id="gender" name="gender" value="<?php echo $gender; ?>" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched select">
														<?php
														if ($gender == "M") {
														?>
											...
											<div class="col-sm-6">
												<div class="mda-form-group label-floating">
													<input type="text" id="date_of_birth" value="<?php echo $date_of_birth; ?>" name="date_of_birth" class="mda-form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched">
											...
											<div id="custom_fields" style="padding-top: 10px;" class="row">
												...
												foreach ($custom_fields as $idx => $fieldsvalues) {
														...
														while ($te < $field_options_count) {
															if (preg_match("/,/", $field_options_array[$te])) {
																...
																if (($A_field_type == 'SELECT') or ($A_field_type == 'MULTI')) {
																	...
																	if ($custom_fields_values->{$A_field_label} == "$field_options_value_array[0]") {
													...
													if ($A_field_type == 'DATE') {
														if ((strlen($custom_fields_values->{$A_field_label}) < 1) or ($custom_fields_values->{$A_field_label} == 'NULL')) {
															$custom_fields_values->{$A_field_label} = 0;
														}
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#identity_issued_on').datetimepicker({ //start date contacts
			icons: {
				//time: 'fa fa-clock-o',
				date: 'fa fa-calendar',
				up: 'fa fa-chevron-up',
							...
							success: function(data) {
								...
								if (data == 1) {
									swal({
										...
										text: "<?php $lh->translateText("contact_update_success"); ?>",
										type: "success"
									}, function() {
										location.reload();
									});
