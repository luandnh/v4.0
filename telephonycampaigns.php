		...
		<section class="content">
			<div class="panel panel-default">
				<div class="panel-body">
									...
									<table class="table table-striped table-bordered table-hover" id="table_leadfilter">
										...
										<tbody>
											...
											?>
												<tr>
													<td>
														<avatar username='<?php echo $leadfilter->lead_filter_name[$i]; ?>' :size='36'></avatar>
													</td>
					...
					?>
					<div class="bottom-menu skin-blue <?php if ($perm->campaign->campaign_create == 'N' && $perm->disposition->disposition_create == 'N') {
															echo "hidden";
														} ?>">
						...
						<div class="row">
							...
							<fieldset>
								...
								<div class="form-group carrier-to-use custom-prefix">
									...
									<div class="col-lg-8 mb">
										<input type="number" class="form-control" id="custom_prefix" name="custom_prefix" value="<?php if (($campaign->data->dial_prefix == "CUSTOM") && ($campaign->data->dial_prefix == 0) || ($campaign->data->dial_prefix == '')) {
																																		echo 9;
																																	} else {
								...
								<div class="form-group outbound blended">
									...
									<div class="col-lg-7 mb">
										<select class="form-control" id="answering-machine-detection" name="answering_machine_detection">
											...
											<option value="8368" selected>OFF</option>
										</select>
									</div>
								</div>
								<!-- <div class="form-group outbound blended">
