					...
					},
					{
						...
						render: function(data, type, row) {
							...
							<ul class='dropdown-menu' role='menu'>
								<li><a class='play_audio' href='#' data-location='${data.location}' data-details='<strong>Phone</strong>: <i>${data.phone_number}</i><br/><strong>Date</strong>: <i>${data.start_time}</i><br/>'>Play Recording</a></li>
								<li><a class='download-call-recording' href='${data.location}' download>Download Call Recording</a></li>
