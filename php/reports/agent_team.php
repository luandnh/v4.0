...
*/
                ...
                $inbound_report .= '
				<div>
						<legend><small><em class="fa fa-arrow-right"></em><i> Agent By Team</i></small></legend>
								<table class="display responsive no-wrap table table-striped table-bordered table-hover" id="agent_team">
										<thead>
												<tr>
														<th > Team</th>
														<th > Total call</th>
