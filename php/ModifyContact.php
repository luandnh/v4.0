...
if (isset($_POST["identity_number"])) {
	...
	$identity_number 									= stripslashes($identity_number);
}
...
if (isset($_POST["vendor_lead_code"])) {
	...
	$vendor_lead_code 									= stripslashes($vendor_lead_code);
}
...
// identity_issued_on
$identity_issued_on 										= NULL;
if (isset($_POST["identity_issued_on"])) {
	$identity_issued_on 									= $_POST["identity_issued_on"];
	$identity_issued_on 									= date("Y-m-d h:i:s", strtotime($identity_issued_on));
	$identity_issued_on 									= stripslashes($identity_issued_on);
}

// identity_issued_by
$identity_issued_by 										= NULL;
if (isset($_POST["identity_issued_by"])) {
	$identity_issued_by 									= $_POST["identity_issued_by"];
	$identity_issued_by 									= stripslashes($identity_issued_by);
}
