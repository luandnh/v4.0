...
$assigned_users = $api->API_getAssignedUsers($campaign_id);
?>
<html>
							...
							<div class="panel-body">
								...
								<div role="tabpanel">
									...
									<ul role="tablist" class="nav nav-tabs nav-justified">
										...
										<li><a href="#tab_3" data-toggle="tab"><?php $lh->translateText("assign_settings"); ?></a></li>
									</ul>
									<!-- Tab contents-->
									<div class="tab-content">
												...
												<div class="form-group">
													...
													<div class="col-sm-9 mb">
														<div class="row">
															...
															<div class="col-lg-3">
																<input type="number" class="form-control" id="custom_prefix" name="custom_prefix" min="0" value="<?php if (($campaign->data->dial_prefix == "CUSTOM") && ($campaign->data->dial_prefix == 0) || ($campaign->data->dial_prefix == '')) {
																																										echo 9;
																																									} else {
																																										echo $campaign->data->dial_prefix;
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															<select id="campaign_vdad_exten" name="campaign_vdad_exten" class="form-control">
																<option value="<?php if ($campaign->campaign_type == "SURVEY") {
																					echo '8366';
																				} else {
																					echo '8368';
																				} ?>" <?php if ($campaign->data->campaign_vdad_exten == "8368" || $campaign->data->campaign_vdad_exten == "8366") echo "selected"; ?>>OFF</option>
																<option value="<?php if ($campaign->campaign_type == "SURVEY") {
																					echo '8373';
																				} else {
																					echo '8369';
																				}  ?>" <?php if ($campaign->data->campaign_vdad_exten == "8369" || $campaign->data->campaign_vdad_exten == "8373") echo "selected"; ?>>ON</option>
															</select>
														</div>
													</div>
												<?php } ?>
														...
														<div class="col-sm-9 mb">
															<select class="form-control" id="hopper_level" name="hopper_level">
																...
																foreach ($hopper_level as $level) {
																	$selectThis = '';
																	if ($level == $campaign->data->hopper_level) {
																		$selectThis = 'selected';
																	}
										...
										<div class="tab-pane fade in" id="tab_2">
											<fieldset>
												<div class="form-group" hidden>
													...
													<div class="col-sm-9 mb">
														<div id="flag" class="flag flag-<?php if (!empty($campaign->country_codes->{$campaign->default_country_code}->tld)) {
																							echo $campaign->country_codes->{$campaign->default_country_code}->tld;
																						} else {
																							echo "us";
																						} ?>" style="position: absolute; top: 11px; left: 30px;"></div>
												...
												<?php if ($campaign->campaign_type != "SURVEY") { ?>
													...
													<div class="form-group" hidden>
														...
														<div class="col-sm-9 mb">
															<input type="text" class="form-control" value="<?php if (!empty($campaign->custom_fields_list_id)) {
																												echo $campaign->custom_fields_list_id;
													...
													<div class="form-group" hidden>
														...
														<div class="col-sm-3 mb">
															<input type="text" class="form-control" placeholder="Enter Title" value="<?php if (!empty($campaign->url_tab_first_title)) {
																																			echo $campaign->url_tab_first_title;
																																		} ?>" id="url_tab_first_title" name="url_tab_first_title">
														</div>
														<div class="col-sm-6 mb">
															<input type="text" class="form-control" placeholder="Enter URL (eg. https://www.goautodial.com, URL must be served over HTTPS)" value="<?php if (!empty($campaign->url_tab_first_url)) {
																																																		echo $campaign->url_tab_first_url;
																																																	} ?>" id="url_tab_first_url" name="url_tab_first_url">
														</div>
													</div>
													<div class="form-group" hidden>
														<label class="col-sm-3 control-label">URL Tab 2:</label>
														<div class="col-sm-3 mb">
															<input type="text" class="form-control" placeholder="Enter Title" value="<?php if (!empty($campaign->url_tab_second_title)) {
																																			echo $campaign->url_tab_second_title;
																																		} ?>" id="url_tab_second_title" name="url_tab_second_title">
														</div>
														<div class="col-sm-6 mb">
															<input type="text" class="form-control" placeholder="Enter URL (eg. https://www.goautodial.com, URL must be served over HTTPS)" value="<?php if (!empty($campaign->url_tab_second_url)) {
																																																		echo $campaign->url_tab_second_url;
																																																	} ?>" id="url_tab_second_url" name="url_tab_second_url">
														</div>
													</div>
													...
													<div class="form-group<?= (empty($campaign->data->nextdial_seconds) ? ' hidden' : '') ?>">
														...
														<div class="col-sm-9 mb">
															<input type="number" min="3" max="60" class="form-control" value="<?php if (!empty($campaign->data->nextdial_seconds)) {
																																	echo $campaign->data->nextdial_seconds;
																																} ?>" id="nextdial_seconds" name="nextdial_seconds">
														</div>
													</div>
												<?php } ?>
												<?php if ($campaign->campaign_type == "OUTBOUND") { ?>
													<div class="form-group" style="margin-bottom: 10px;" hidden>
														<?php $dial_statuses = explode(" ", rtrim($campaign->data->dial_statuses, " -"));
														$i = 1; ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															...
															<!-- <option value="998" <?php //if($campaign->data->manual_dial_list_id == 998 || $campaign->data->manual_dial_list_id == 0) echo "selected";
																						?>>998</option>
																		<option value="999" <?php //if($campaign->data->manual_dial_list_id == 999) echo "selected";
																							?>>999</option> -->
															<?php //for($i=0;$i<count($lists->list_id);$i++){ 
															?>
															<!--<option value="<?php //echo $lists->list_id[$i];
																				?>" <?php //if($lists->list_id[$i] == $campaign->data->manual_dial_list_id) echo "selected";
																					?>><?php //echo $lists->list_id[$i]; 
																						?></option>';-->
															<?php //} 
															?>
															<!--</select>-->
															<input type="text" class="form-control" id="manual_dial_list_id" name="manual_dial_list_id" value="<?php if ($campaign->data->manual_dial_list_id != '') {
																																									echo $campaign->data->manual_dial_list_id;
																																								} else {
																																									echo "998";
																																								} ?>">
														</div>
													...
													<div class="form-group" hidden>
														...
														<div class="col-sm-9 mb">
															<input type="text" class="form-control" value="<?php if (!empty($campaign->data->xferconf_a_number)) {
																												echo $campaign->data->xferconf_a_number;
																											} else {
																												echo "";
																											} ?>" id="xferconf_a_number" name="xferconf_a_number">
														</div>
													</div>
													<div class="form-group" hidden>
														<label class="col-sm-3 control-label">Transfer-Conf Number 2:</label>
														<div class="col-sm-9 mb">
															<input type="text" class="form-control" value="<?php if (!empty($campaign->data->xferconf_b_number)) {
																												echo $campaign->data->xferconf_b_number;
																											} else {
																												echo "";
																											} ?>" id="xferconf_b_number" name="xferconf_b_number">
														</div>
													</div>
													<div class="form-group" hidden>
													...
													<div class="form-group" hidden>
														...
														<div class="col-sm-9 mb">
															<input type="number" class="form-control" id="customer_3way_hangup_seconds" name="customer_3way_hangup_seconds" min="0" value="<?php if (!empty($campaign->data->customer_3way_hangup_seconds)) {
																																																echo $campaign->data->customer_3way_hangup_seconds;
																																															} else {
																																																echo "5";
												...
												<?php } elseif ($campaign->campaign_type == "SURVEY") { ?>
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															<input type="number" class="form-control" id="survey_ni_digit" name="survey_ni_digit" min="0" maxlength="10" value="<?php if (!empty($campaign->data->survey_ni_digit)) {
																																													echo $campaign->data->survey_ni_digit;
																																												} else {
																																													echo "8";
																																												} ?>">
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															<input type="number" class="form-control" id="survey_wait_sec" name="survey_wait_sec" min="0" maxlength="10" value="<?php if (!empty($campaign->data->survey_wait_sec)) {
																																													echo $campaign->data->survey_wait_sec;
																																												} else {
																																													echo "10";
																																												} ?>">
														</div>
													...
													<!--<div class="form-group">
																	...
																	<div class="col-sm-7 mb">
																		<input type="text" class="form-control" id="survey_ni_audio_file" name="survey_ni_audio_file" value="<?php if (!empty($campaign->data->survey_ni_audio_file)) {
																																													echo $campaign->data->survey_ni_audio_file;
																																												} else {
																																													echo "sip-silence";
																																												} ?>">
																	</div>
															...
															<select class="form-control select2 survey_ni_audio_file_dropdown" id="survey_ni_audio_file_dropdown" data-label="survey_ni_audio_file">
																...
																<?php for ($i = 0; $i <= count($voicefiles->file_name); $i++) { ?>
																	<?php if (!empty($voicefiles->file_name[$i])) { ?>
																		...
																		?>
																		<!--option value="<?php //echo substr($audiofiles->data[$i], 0, -4); 
																							?>"><?php //echo substr($audiofiles->data[$i], 0, -4); 
																								?></option-->
													...
													<!--<div class="form-group">
																	...
																	<div class="col-sm-7 mb">
																		<input type="text" class="form-control" id="survey_third_audio_file" name="survey_third_audio_file" value="<?php if (!empty($campaign->data->survey_third_audio_file)) {
																																														echo $campaign->data->survey_third_audio_file;
																																													} else {
																																														echo "sip-silence";
																																													} ?>">
																	</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															<input type="number" class="form-control" id="survey_third_exten" name="survey_third_exten" min="0" value="<?php if (!empty($campaign->data->survey_third_exten)) {
																																											echo $campaign->data->survey_third_exten;
																																										} else {
																																											echo "8300";
																																										} ?>">
														</div>
													...
													<!--<div class="form-group">
																	...
																	<div class="col-sm-7 mb">
																		<input type="text" class="form-control" id="survey_fourth_audio_file" name="survey_fourth_audio_file" value="<?php if (!empty($campaign->data->survey_fourth_audio_file)) {
																																															echo $campaign->data->survey_fourth_audio_file;
																																														} else {
																																															echo "sip-silence";
																																														} ?>">
																	</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-9 mb">
															<input type="number" class="form-control" id="survey_fourth_exten" name="survey_fourth_exten" min="0" value="<?php if (!empty($campaign->data->survey_fourth_exten)) {
																																												echo $campaign->data->survey_fourth_exten;
																																											} else {
																																												echo "8300";
																																											} ?>">
														</div>
												...
												?>
													...
													<div class="form-group<?= (empty($googleAPIKey) ? ' hidden' : '') ?>" style="margin-bottom: 10px;">
														<?php $google_sheet_ids = explode(" ", rtrim($campaign->google_sheet_ids, " -"));
														$i = 1; ?>
										...
										<div id="tab_3" class="tab-pane fade in">
											<div role="tabpanel">
												<!--<div class="nav-tabs-custom">-->
												<ul role="tablist" class="nav nav-tabs nav-justified">
													<li class="active"><a href="#assign_tab_1" data-toggle="tab"><?php $lh->translateText("user_groups"); ?></a></li>
													<li><a href="#assign_tab_2" data-toggle="tab"><?php $lh->translateText("agents"); ?></a></li>
												</ul>
												<!-- Tab contents-->
												<div class="tab-content">
													<div id="assign_tab_1" class="tab-pane fade in active">
														<div class="row">
															<div class="col-md-5">
																<h4 style="font-weight:bold;">Available</h4>
															</div>
															<div class="col-md-offset-2 col-md-5">
																<h4 style="font-weight:bold;">Not Assigned</h4>
															</div>
														</div>
														<div class="row">
															<style>
																#filter_usergroups_multiselect {
																	overflow: hidden;
																	font-size: 17px;
																}

																#filter_usergroups_multiselect_to {
																	overflow: hidden;
																	font-size: 17px;
																}
															</style>
															<div class="col-md-5">
																<select name="usergroups_assign" id="filter_usergroups_multiselect_to" class="form-control" size="8" multiple="multiple"></select>
															</div>
															<div class="col-md-2">
																<button type="button" id="filter_usergroups_multiselect_rightAll" class="btn btn-outline-success btn-rounded btn-block"><i class="fa fa-angle-double-right"></i></button>
																<button type="button" id="filter_usergroups_multiselect_rightSelected" class="btn btn-outline-primary btn-rounded btn-block"><i class="fa fa-chevron-right"></i></button>
																<button type="button" id="filter_usergroups_multiselect_leftSelected" class="btn btn-outline-primary btn-rounded btn-block"><i class="fa fa-chevron-left"></i></button>
																<button type="button" id="filter_usergroups_multiselect_leftAll" class="btn btn-outline-success btn-rounded btn-block"><i class="fa fa-angle-double-left"></i></button>
															</div>
															<div class="col-md-5">
																<select id="filter_usergroups_multiselect" class="form-control" size="8" multiple="multiple">
																</select>
															</div>
														</div>
														<div class="row">
															<div class="col-md-12">
																<div class="checkbox">
																	<label>
																		<input id="checkbox_usergroups" name="checkbox_usergroups" type="checkbox"> Assign all users in Groups
																	</label>
																</div>
															</div>
														</div>
													...
													<div class="tab-pane fade in" id="assign_tab_2">
														<div class="row">
															<div class="col-md-5">
																<h4 style="font-weight:bold;">Available</h4>
															</div>
														...
														<div class="row">
															<style>
																#filter_users_multiselect {
																	overflow: hidden;
																	font-size: 17px;
																}

																#filter_users_multiselect_to {
																	overflow: hidden;
																	font-size: 17px;
																}
															</style>
															<div class="col-md-5">
																<select name="users_assign" id="filter_users_multiselect_to" class="form-control" size="8" multiple="multiple"></select>
															</div>
															<div class="col-md-2">
																<button type="button" id="filter_users_multiselect_rightAll" class="btn btn-outline-success btn-rounded btn-block"><i class="fa fa-angle-double-right"></i></button>
																<button type="button" id="filter_users_multiselect_rightSelected" class="btn btn-outline-primary btn-rounded btn-block"><i class="fa fa-chevron-right"></i></button>
																<button type="button" id="filter_users_multiselect_leftSelected" class="btn btn-outline-primary btn-rounded btn-block"><i class="fa fa-chevron-left"></i></button>
																<button type="button" id="filter_users_multiselect_leftAll" class="btn btn-outline-success btn-rounded btn-block"><i class="fa fa-angle-double-left"></i></button>
															</div>
															<div class="col-md-5">
																<select id="filter_users_multiselect" class="form-control" size="8" multiple="multiple">
																</select>
															</div>
														</div>
														<div class="row">
															<div class="col-md-12">
																<div class="checkbox">
																	<label>
																		<input id="checkbox_users" name="checkbox_users" type="checkbox"> Assign all users in list
																	</label>
																</div>
															</div>
														</div>
													...
													<fieldset class="footer-buttons">
														<div class="box-footer">
															<div class="col-sm-2 pull-right">
																<button type="button" class="btn btn-warning" id="assignCampaignOkButton" href=""> <span id="update_button"><i class="fa fa-check"></i><?php $lh->translateText("assign"); ?></span></button>
															</div>
														</div>
													</fieldset>
												</div>
							...
							<div class="box-body table-responsive no-padding">
								<table id="table_edit_disposition" class="table table-hover">
									...
									<tbody>
										...
										<td>
											<div style="border: 1px solid #888; background-color: <?php echo $disposition->color[$i]; ?>; width: 40px;">&nbsp; &nbsp;</div>
												...
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->selectable[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->human_answered[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->sale[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->dnc[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" id="customer_contact" class="flat-red" <?php if ($disposition->customer_contact[$i] == "Y") {
																														echo checked;
																													} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->not_interested[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->unworkable[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<td class="custom_statuses">
													<input type="checkbox" class="flat-red" <?php if ($disposition->scheduled_callback[$i] == "Y") {
																								echo checked;
																							} ?> />
												</td>
												<!-- ACTION BUTTONS -->
										...
										<!-- ADD A NEW STATUS -->
										<tr>
											<td colspan="13" style="background: #ecf0f5; font-size: 5px;">&nbsp;</td>
										</tr>
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td class="custom_statuses">
													<?php if ($leadrecycling->data->active == "Y") echo "Active";
													else echo "Inactive"; ?>
												</td>
												...
												<td>
													<center>
														<a class="edit_leadrecycling btn btn-primary" href="#" data-toggle="modal" data-target="#edit_leadrecycling_modal" data-id="<?php echo $leadrecycling->data->recycle_id; ?>" data-status="<?php echo $leadrecycling->data->status; ?>" data-attemptdelay="<?php echo $leadrecycling->data->attempt_delay; ?>" data-attemptmaximum="<?php echo $leadrecycling->data->attempt_maximum; ?>" data-active="<?php echo $leadrecycling->data->active; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	function empty_statuses() {
		...
		swal({
			title: "Oops...",
			text: "This campaign has no existing disposition. You are going to be redirected after a few seconds!",
			timer: 4000,
	...
	function duplicate_status_check(status_id, addoredit) {
		...
		var campaign_form_value = "<?php if (isset($did)) {
										echo $did;
									} else {
										echo "";
									} ?>";
...
<script type="text/javascript" defer>
	$(document).ready(() => {
		const usergroupsStr = '<?= json_encode($usergroups->data) ?>';
		const usergroups = JSON.parse(usergroupsStr);
		let group_option_from = "";
		let group_option_to = "";
		usergroups.forEach((element) => {
			if (element.allowed_campaigns.match(/ALL-CAMPAIGNS/)) {
				group_option_to += `<option value='${element.user_group}'>${element.group_name}</option>`;
			} else if (element.allowed_campaigns.match(/\s<?= $campaign_id ?>\s/)) {
				group_option_to += `<option value='${element.user_group}'>${element.group_name}</option>`;
			} else {
				group_option_from += `<option value='${element.user_group}'>${element.group_name}</option>`;
			}
		});
		$("#filter_usergroups_multiselect").append(group_option_from);
		$("#filter_usergroups_multiselect_to").append(group_option_to);
		$("#filter_usergroups_multiselect").multiselect({
			right: '#filter_usergroups_multiselect_to',
			rightAll: '#filter_usergroups_multiselect_leftAll',
			rightSelected: '#filter_usergroups_multiselect_leftSelected',
			leftSelected: '#filter_usergroups_multiselect_rightSelected',
			leftAll: '#filter_usergroups_multiselect_rightAll',
			search: {
		...
		const dataStr = '<?= json_encode($assigned_users->data) ?>';
		const usersData = JSON.parse(dataStr);
		group_option_from = "";
		group_option_to = "";
		userAssigned = usersData.assigned;
		usersData.all.forEach((element) => {
			userAssigned.forEach(assigned => {
				if (assigned.user == element.user) {
					group_option_to += `<option value='${element.user_id}'>${element.full_name}</option>`;
					return false;
				}
			});
			group_option_from += `<option value='${element.user_id}'>${element.full_name}</option>`;
		});

		$("#filter_users_multiselect").append(group_option_from);
		$("#filter_users_multiselect_to").append(group_option_to);
		$("#filter_users_multiselect").multiselect({
			right: '#filter_users_multiselect_to',
			rightAll: '#filter_users_multiselect_leftAll',
			rightSelected: '#filter_users_multiselect_leftSelected',
			leftSelected: '#filter_users_multiselect_rightSelected',
			leftAll: '#filter_users_multiselect_rightAll',
			search: {
				left: '<input type="text" name="q" class="form-control" placeholder="Search..." />',
				right: '<input type="text" name="q" class="form-control" placeholder="Search..." />',
			},
		});
		console.log(document.getElementById("campaign_form_assign"));
	});
	$("#checkbox_usergroups").on("change", () => {
		if ($("#checkbox_users")[0].checked) {
			$("#checkbox_users").prop('checked', false);
		}
	})
	$("#checkbox_users").on("change", () => {
		if ($("#checkbox_usergroups")[0].checked) {
			$("#checkbox_usergroups").prop('checked', false);
		}
	})
	$("#assignCampaignOkButton").on("click", (e) => {
		e.preventDefault();
		swal({
				title: "Are you sure?",
				...
				showCancelButton: true,
				confirmButtonColor: "#DD6B55",
				confirmButtonText: "Yes, assign agents !",
			...
			function(isConfirm) {
				if (isConfirm) {
					let valid = true;
					let form_assign = document.getElementById("campaign_form_edit").elements;
					let user_checked = form_assign["checkbox_users"].checked;
					let usergroup_checked = form_assign["checkbox_usergroups"].checked;
					form = {
						"campaign_id": form_assign["campaign_id"].value,
						"campaign_type": form_assign["campaign_type"].value,
						"log_user": form_assign["log_user"].value,
						"log_group": form_assign["log_group"].value,
						"is_usergroups": usergroup_checked,
						"is_users": user_checked,
						"usergroups_assign": [],
						"users_assign": [],
					};
					if (usergroup_checked == user_checked) {
						valid = false;
						sweetAlert("Cancelled", "Please check update by usergroups or user", "error");
					}
					let usergroups_select = $.makeArray($("#filter_usergroups_multiselect_to option"));
					let usergroups_arr = [];
					usergroups_select.forEach((id, el) => {
						usergroups_arr.push($(id).val());
					});
					let users_select = $.makeArray($("#filter_users_multiselect_to option"));
					let users_arr = [];
					users_select.forEach((id, el) => {
						users_arr.push($(id).val());
					});
					form["usergroups_assign"] = usergroups_arr;
					form["users_assign"] = users_arr;
					if (valid) {
						$.ajax({
							url: "./php/AssignUsers.php",
							data: form,
							type: 'POST',
							success: function(result) {
								if (result == "1") {
									swal({
											title: "<?php $lh->translateText("success"); ?>",
											text: "<?php $lh->translateText("users_assign_success"); ?>",
											type: "success"
										},
										function() {
											window.location.href = 'telephonycampaigns.php';
									...
									sweetAlert("<?php $lh->translateText("oups"); ?>", "<?php $lh->translateText("something_went_wrong"); ?>" + result, "error");
								}
							},
							error: function(jqXHR, textStatus, errorThrown) {
								sweetAlert('<?php print $lh->translationFor("system_error"); ?>', 'Something is wrong!', 'error');
							}
						})
					}
				}
